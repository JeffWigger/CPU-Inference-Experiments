...
def crate_plot(datasets, labels, width, name, title):
    ...
    ax.set_title(title)
    ax.set_xticks(x_pos + width, b_sizes)
...
crate_plot(datasets, labels, width, "resnet_compiled.svg", "Resnet Compiled")
...
crate_plot(datasets, labels, width, "bert_compiled.svg", "Bert Compiled")
...
crate_plot(datasets, labels, width, "resnet_ovn.svg", "Resnet OpenVino")
...
crate_plot(datasets, labels, width, "bert_ovn.svg", "Bert OpenVino")
...
crate_plot(datasets, labels, width, "resnet_ipex.svg", "Resnet IPEX")


b_compiled_ipex = df_b[df_b.experiment == "bert_compile_ipex"]
datasets = [b_no_opt, b_compiled_ipex]
labels = ["No Optimization", "Compiled IPEX"]
crate_plot(datasets, labels, width, "bert_ipex.svg", "Bert IPEX")
...
crate_plot(datasets, labels, width, "resnet_onnx.svg", "Resnet ONNX")

b_onnx = df_b[df_b.experiment == "bert_onnx"]
datasets = [b_no_opt, b_onnx]
labels = ["No Optimization", "ONNX"]
crate_plot(datasets, labels, width, "bert_onnx.svg", "Bert ONNX")
